...
class DeltaApplyEngine {
	public:
		...
		void ApplyDeltaElement(xercesc_2_2::DOMNode* incDeltaElement);
	...
	private:
		...
		static xercesc_2_2::DOMNode* getDeltaElement(XID_DOMDocument *IncDeltaDoc);
		xercesc_2_2::DOMNode* deltaElement ;
		
		XID_DOMDocument* moveDocument ;
		
		void ApplyOperation(xercesc_2_2::DOMNode *operationNode);
		...
		void Subtree_Insert( xercesc_2_2::DOMNode *insertSubtreeRoot, XID_t parentXID, int position, const char *xidmapStr );
